...
"""
Test KHAZAD_DUM pipeline with mock broker
...
from src.trading_engines.tradingagents_integration.portfolio_context import PortfolioContextProvider


def test_khazad_dum_pipeline_with_mock():
    """Test complete KHAZAD_DUM pipeline with mock broker"""
    
    print("\n" + "="*60)
    print("KHAZAD_DUM PIPELINE WITH MOCK BROKER TEST")
    print("="*60)
    ...
    print("\n✅ KHAZAD_DUM Pipeline Mock Test Complete!")


if __name__ == "__main__":
    test_khazad_dum_pipeline_with_mock()