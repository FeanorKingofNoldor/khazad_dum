...
"""
Test script for KHAZAD_DUM with IBKR portfolio integration
"""
...
def test_ibkr_integration():
    """
    Test the complete KHAZAD_DUM system with IBKR portfolio integration
    """
    print("Testing KHAZAD_DUM with IBKR Integration")
    print("=" * 50)
    ...
    try:
        wrapper_paper = AgentWrapper(
            khazad_dum_database=db,
            use_ibkr=True,
    ...
    print("# wrapper_live = AgentWrapper(db, use_ibkr=True, ibkr_port=4001)")


def test_portfolio_data_flow():
    """
    Test the data flow from IBKR through KHAZAD_DUM to TradingAgents
    """
    print("\n" + "="*60)
...
if __name__ == "__main__":
    ...
    try:
        ...
        if choice.lower() == 'y':
            ...
            print(f"\nAnalyzing {symbol} with full KHAZAD_DUM context...")
