...
from src.core.pattern_recognition import PatternDatabase, PatternClassifier, PatternTracker
from src.core.pattern_recognition.memory_injector import PatternMemoryInjector
from src.core.pattern_recognition.memory_bridge import TradingAgentsMemoryBridge
...
def test_full_pattern_flow():
    ...
    if os.path.exists("khazad_dum.db"):
        db = DatabaseManager()  # Uses default
    else:
        # Create DatabaseManager with specific path
        db = DatabaseManager()
