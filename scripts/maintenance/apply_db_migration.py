#!/usr/bin/env python3
"""
Apply database migrations for KHAZAD_DUM Pattern System
"""
...
def apply_migration(db_path: str = "khazad_dum.db", migration_file: str = "001_add_pattern_tables.sql"):
...
def verify_migration(db_path: str = "khazad_dum.db"):
